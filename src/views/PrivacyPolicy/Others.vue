<template>
	<div>
		<section class="disclosure">
			<h2 class="subs">Disclosure of Your Personal Data</h2>
		...
		<section class="security">
			<h2 class="subs">Security of Your Personal Data</h2>
			<p>
			...
			<h2 class="subs">Children's Privacy</h2>
			<p>
			...
			<h2 class="subs">Links to Other Websites</h2>
